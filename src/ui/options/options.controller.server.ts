...
class OptionsController {
  ...
  private _getFileOptionsDisplay(): string {
    ...
    return (
      ...
      '<input class="form-check-input" type="checkbox" name="trashSourceFile" id="trashSourceFile" ' +
      selected.trashSourceFile +
      '>' +
      ...
      '<div class="form-group">' +
      '<div class="form-check">' +
      '<input class="form-check-input" type="checkbox" id="createInMyDrive" ' +
      selected.createInMyDrive +
      '>' +
